...
class PrefManager {
  ...
  //for Bloc.Bloc.login
  set isFirst(bool value) => preferences.setBool(kIsFirst, value);

  bool get isFirst => preferences.getBool(kIsFirst) ?? false;
  ...
  set locale(String? value) => preferences.setString(kLocale, value ?? 'fa');

  String get locale => preferences.getString(kLocale) ?? 'fa';

  /// Default locale set to English
  set theme(String? value) => preferences.setString(kTheme, value ?? ActiveTheme.system.description);

  String get theme => preferences.getString(kTheme) ?? ActiveTheme.system.description;
